...
class Student:
    def __init__(self,root) :
        ...
        #First Img :
        img = Image.open(r"C:\Users\spram\Desktop\Deep Learning based automated Attendance system\images\white.png")
        ...
        #Second Img :
        img1 = Image.open(r"C:\Users\spram\Desktop\Deep Learning based automated Attendance system\images\white.png")
        ...
        #Third Img :
        img2 = Image.open(r"C:\Users\spram\Desktop\Deep Learning based automated Attendance system\images\white.png")
        ...
        #Background
        img3 = Image.open(r"C:\Users\spram\Desktop\Deep Learning based automated Attendance system\images\grey.jpg")
        ...
        title_lbl = Label(bg_img, text = "Student Register System", font=("times new roman",35, "bold" ), bg = "black", fg = "white")
        ...
        img_left = Image.open(r"C:\Users\spram\Desktop\Deep Learning based automated Attendance system\images\grey.jpg")
        img_left = img_left.resize((720, 150), Image.ANTIALIAS)
        self.photoimg_left = ImageTk.PhotoImage(img_left)

        f_lab = Label(Left_frame, image=self.photoimg_left)
        f_lab.place(x = 5, y = 0, width = 730, height = 130)
        ...
        img_right = Image.open(r"C:\Users\spram\Desktop\Deep Learning based automated Attendance system\images\grey.jpg")
        img_right = img_right.resize((720, 150), Image.ANTIALIAS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        f_lab = Label(Right_frame, image=self.photoimg_right)
        f_lab.place(x = 5, y = 0, width = 730, height = 130)
